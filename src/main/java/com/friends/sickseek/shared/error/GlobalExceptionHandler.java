...
import com.friends.sickseek.shared.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SickseekException.class)
    public ResponseEntity<ErrorResponse> handleSickseekException(SickseekException e) {
        return ResponseEntity
